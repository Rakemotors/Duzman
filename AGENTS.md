# AGENTS.md — конвенции проекта Duzman для AI coding agents

Этот файл читается автоматически Codex CLI при работе в репозитории. Идентичная копия для Claude Code лежит в `.claude/skills/duzman-conventions/SKILL.md`. При любом обновлении конвенций — обновляются оба файла.
